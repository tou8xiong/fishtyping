    ...
    <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl z-10 px-6 py-20 flex flex-col items-center text-center gap-16">
        <div className="space-y-6 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-white/5 text-xs font-bold tracking-[0.2em] text-primary uppercase">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
            <Link href="/typing" className="group relative px-10 py-5 bg-primary text-black rounded-2xl font-black text-lg transition-all hover:scale-105 active:scale-95 shadow-[0_20px_50px_rgba(11,175,231,0.2)] overflow-hidden">
              <span className="relative z-10">START TYPING NOW</span>
              <div className="absolute inset-0 bg-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-500 skew-x-12" />
            </Link>
            <Link href="/login" className="px-10 py-5 glass glass-hover rounded-2xl font-bold text-lg text-foreground/80">
              CREATE ACCOUNT
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
          {[
            ...
            <div key={i} className="p-8 glass glass-hover rounded-3xl text-left flex flex-col gap-4">
