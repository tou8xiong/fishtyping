  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-20 px-8 relative overflow-hidden bg-[#020617]">
      ...
      <div className="w-full max-w-md z-10 animate-fade-in">
        ...
        <div className="glass p-8 rounded-lg shadow-2xl border border-white/10 hover:border-white/20 transition-all space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-black uppercase tracking-widest text-foreground/40 px-1">Email Address</label>
            <input
              type="email"
              placeholder="name@example.com"
              className="w-full bg-white/5 border border-white/10 rounded-lg px-5 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all placeholder:text-foreground/20 hover:border-white/20"
            />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center px-1">
              <label className="text-xs font-black uppercase tracking-widest text-foreground/40">Password</label>
              <a href="#" className="text-[10px] font-black uppercase tracking-widest text-primary/60 hover:text-primary transition-colors">Forgot?</a>
            </div>
            <input
              type="password"
              placeholder="••••••••"
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 glass glass-hover py-3 rounded-lg text-xs font-bold border border-white/10 hover:border-white/20 transition-all hover:shadow-md">
