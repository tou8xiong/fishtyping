      ...
      <div className="w-full max-w-5xl z-10 space-y-8 animate-fade-in">
        <div className="flex justify-between items-end px-4">
          ...
          <div className="flex gap-4">
            <div className="px-4 py-2 glass rounded-md text-xs font-bold">
        ...
        <div className="glass p-12 md:p-20 rounded-md shadow-2xl relative overflow-hidden group">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {['Esc - Reset', 'Tab - Settings', 'Ctrl+R - New Test', 'Alt+S - Share'].map((hint, i) => (
            <div key={i} className="px-6 py-4 glass glass-hover rounded-md text-[10px] font-black uppercase tracking-widest text-foreground/30 flex items-center justify-center">
              {hint}
            </div>
          ))}
        </div>
