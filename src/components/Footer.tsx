  ...
  return (
    <footer className="border-t border-white/5 bg-background">
      <div className="mx-auto max-w-7xl px-6 py-12 md:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-3 group w-fit">
              <svg width="28" height="28" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="group-hover:scale-110 transition-transform">
              ...
              <span className="text-lg font-black tracking-tight bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent italic">
                FishTyping
              </span>
            </Link>
            <p className="text-sm text-foreground/40 leading-relaxed max-w-xs">
              A multilingual typing experience built for speed, accuracy, and precision.
            </p>
          </div>

          {/* Navigate */}
          <div className="flex flex-col gap-4">
            <h3 className="text-[10px] font-black uppercase tracking-[0.24em] text-foreground/30">
              Navigate
            </h3>
            <ul className="flex flex-col gap-2.5">
              {[
                { label: "Home", href: "/" },
                { label: "Practice", href: "/typing" },
        ...
        {/* Bottom bar */}
        <div className="mt-10 border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
